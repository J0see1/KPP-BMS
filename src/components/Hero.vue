...
<template>
  ...
  <section class="hero">
    <div class="tag">
      <p>Hi, we are group 7 feel free to have a tour!!</p>
      <button><a href="#"> content</a></button>
    </div>
  </section>
...
.hero {
  width: 100%;
  background: linear-gradient(180deg, #136f63 0%, #84dcc6 100%);
}
